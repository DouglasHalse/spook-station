...
manager.devices[manager.getDeviceIndex(deviceName="EMFReader1")].fluctuationRate = (int(inputFluctuationRate))

inputFluctuationMagnitude = input("Enter desired fluctuation magnitude: ")
manager.devices[manager.getDeviceIndex(deviceName="EMFReader1")].fluctuationMagnitude = (int(inputFluctuationMagnitude))
